...
module.exports = {
  up: (queryInterface, Sequelize) => {
      return queryInterface.bulkInsert('Events', [
        ...
        {name: "Kamigawa Block Drafts", hostId: 1, gameId: 1, date: faker.date.future().toDateString(), locationId: 1, image: "https://lh3.googleusercontent.com/proxy/fs_RDitBSLbreRgjw2e6BFHcWTC7IowVSlO0hJbDbhv_f4h1KFvCROH-jGjX_FZQKaR_F2x2ZR-UWU0tVXcZzu5TtKuR8Ys" },
